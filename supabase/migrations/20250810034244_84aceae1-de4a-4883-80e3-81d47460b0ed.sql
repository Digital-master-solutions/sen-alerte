-- Seed: create a demo organization with valid type and link categories
...
-- 2) Create demo organization if not exists (type must be one of: mairie, ong, prive, benevolat)
INSERT INTO public.organizations (name, type, email, city, phone, status, is_active)
SELECT 'Organisation Démo', 'mairie', 'demo.org@example.com', 'Dakar', '+221700000000', 'approved', true
WHERE NOT EXISTS (
